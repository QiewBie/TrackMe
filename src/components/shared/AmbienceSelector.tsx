            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full mt-2 z-50 bg-bg-surface border border-border rounded-2xl shadow-xl ring-1 ring-black/5 p-4 w-72 max-w-[calc(100vw-2rem)] right-0 origin-top-right md:left-0 md:right-auto md:origin-top-left"
                    >
                        {/* Header */}
