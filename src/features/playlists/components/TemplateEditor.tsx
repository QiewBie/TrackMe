...
export const AVAILABLE_ICONS = [
    { icon: Sunrise, label: 'Morning', color: 'text-tag-amber' },
    { icon: Sun, label: 'Day', color: 'text-tag-amber' }, // Mapped from yellow
    { icon: Flame, label: 'Fireplace', color: 'text-tag-red' }, // Mapped from orange
    { icon: Zap, label: 'Energy', color: 'text-tag-blue' },
    { icon: Clock, label: 'Time', color: 'text-tag-slate' },
    { icon: Briefcase, label: 'Work', color: 'text-tag-amber' }, // Mapped from amber-700
    { icon: Code, label: 'Coding', color: 'text-tag-emerald' },
    { icon: Monitor, label: 'Screen', color: 'text-tag-indigo' },
    { icon: Database, label: 'Data', color: 'text-tag-cyan' },
    { icon: Cpu, label: 'Tech', color: 'text-tag-purple' }, // Mapped from violet
    { icon: Book, label: 'Study', color: 'text-tag-pink' }, // Mapped from rose
    { icon: GraduationCap, label: 'Learn', color: 'text-tag-blue' },
    { icon: Coffee, label: 'Break', color: 'text-tag-amber' },
    { icon: Dumbbell, label: 'Fitness', color: 'text-tag-red' },
    { icon: Heart, label: 'Health', color: 'text-tag-pink' },
    { icon: Music, label: 'Music', color: 'text-tag-pink' }, // Mapped from fuchsia
    { icon: Gamepad2, label: 'Game', color: 'text-tag-purple' },
    { icon: Star, label: 'Focus', color: 'text-tag-amber' }, // Mapped from yellow
];
