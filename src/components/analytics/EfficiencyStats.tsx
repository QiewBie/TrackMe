...
const EfficiencyStats: React.FC<EfficiencyStatsProps> = ({ completionRate, avgDuration }) => {
    ...
    const StatCard = ({ icon: Icon, label, value, color }: any) => (
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex items-center gap-3 h-full relative overflow-hidden">
            {/* Background Decor */}
