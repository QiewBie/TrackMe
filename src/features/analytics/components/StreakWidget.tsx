...
const StreakWidget: React.FC<StreakWidgetProps> = ({ current, max }) => {
    ...
    return (
        <div className="bg-gradient-to-br from-brand-primary to-brand-secondary dark:from-brand-primary dark:to-brand-secondary/80 rounded-3xl px-4 py-3 text-white shadow-sm relative overflow-hidden group h-full flex items-center justify-between">
